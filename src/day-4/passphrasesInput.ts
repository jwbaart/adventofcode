...
const passphrasesRaw = `vxjtwn vjnxtw sxibvv mmws wjvtxn icawnd rprh
...
const extractPassphrasesInput = (passphrasesText): Passphrases => {
    const passphrasesArray = passphrasesText.split("\n");
    const passphrases = passphrasesArray.map(passphrase => {
...
export const passphrasesInput = extractPassphrasesInput(passphrasesRaw);
